...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  return (
     <div className='group bg-zinc-900 col-span relative h-[12vw]'>
        <img src={data.thumbnailUrl} alt="Movie"  className='cursor-pointer object-cover transition duration 
        ...
        group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100'>
            ...
            <div className=' z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md '>
                <div className='flex flex-row items-center gap-3'>
                    <div className='bg-white w-6 h-6 lg:w-10 lg:h-10 rounded-full cursor-pointer flex justify-center items-center transition hover:bg-neutral-300'>
